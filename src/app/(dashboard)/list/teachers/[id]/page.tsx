  ...
  return (
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
        ...
        <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
            {/* CARD */}
            <Image src='/singleBranch.png' alt='singleBranch' width={24} height={24} className="w-6 h-6" />
            <div className="">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
            {/* CARD */}
            <Image src='/singleClass.png' alt='singleClass' width={24} height={24} className="w-6 h-6" />
            <div className="">
                <h1 className="text-xl font-semibold">6</h1>
        ...
        <div className="bg-white p-4 rounded-md">
            ...
            <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                <Link href='/' className="p-3 rounded-md bg-starSkyLight">Teacher&apos;s Classes</Link>
                <Link href='/' className="p-3 rounded-md bg-starPurpleLight">Teacher&apos;s Students</Link>
                <Link href='/' className="p-3 rounded-md bg-starYellowLight">Teacher&apos;s Lessons</Link>
                <Link href='/' className="p-3 rounded-md bg-pink-50">Teacher&apos;s Exams</Link>
                <Link href='/' className="p-3 rounded-md bg-starSkyLight">Teacher&apos;s Assignments</Link>
            </div>
        </div>
        <Performance />
        <Announcements />
