    ...
    <div className='ng-white p-4 rounded-md'>
        ...
        <div className="flex flex-col gap-4 mt-4">
            <div className="bg-starSkyLight rounded-md p-4">
                ...
                <p className="text-sm text-gray-400 mt-1">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quasi velit facilis, consectetur consequatur provident dolore eos officia qui! Nisi voluptas fuga id alias ad neque repellendus assumenda quo nostrum excepturi!</p>
            </div>
